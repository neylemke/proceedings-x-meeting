...
print("Compilando os arquivos dos resumos")
os.system("cd papers; for file in art*.tex; do pdflatex $file; done")

print("Compilando os Proceedings")
os.system("pdflatex procxmeeting2017; makeindex procxmeeting2017;pdflatex procxmeeting2017;pdflatex procxmeeting2017")
